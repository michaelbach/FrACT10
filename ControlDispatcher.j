...
+ (void) manageSetSetting {
    ...
    const allowedBoolSettings = ["isGratingObliqueOnly", "showResponseInfoAtStart", "enableTouchControls", "eccentShowCenterFixMark", "eccentRandomizeX", "autoFullScreen", "respondsToMobileOrientation", "showTrialInfo", "putResultsToClipboardSilent", "showRewardPicturesWhenDone", "embedInNoise", "isAcuityColor", "isLandoltObliqueOnly", "acuityHasEasyTrials", "showAcuityFormatDecimal", "showAcuityFormatLogMAR", "showAcuityFormatSnellenFractionFoot", "forceSnellen20", "showCI95", "isLineByLineChartModeConstantVA", "contrastHasEasyTrials", "isContrastDarkOnLight", "contrastShowFixMark", "isContrastDithering", "isGratingMasked", "isGratingErrorDiffusion", "isGratingColor", "specialBcmOn", "hideExitButton", "giveAuditoryFeedback4run"];
    if (allowedBoolSettings.includes(m2)) {
        [self setSettingNamed: m2];  return;
    }
    const allowedNumberSettings = ["nAlternativesIndex", "nTrials02", "nTrials04", "nTrials08", "distanceInCM", "calBarLengthInMM", "testOnFive", "decimalMarkCharIndex", "testOnFive", "eccentXInDeg", "eccentYInDeg", "displayTransform", "trialInfoFontSize", "timeoutIsiMillisecs", "timeoutResponseSeconds", "timeoutDisplaySeconds", "soundVolume", "auditoryFeedback4trialIndex", "timeoutRewardPicturesInSeconds", "resultsToClipboardIndex", "noiseContrast", "contrastAcuityWeber", "maxDisplayedAcuity", "minStrokeAcuity", "acuityStartingLogMAR", "margin4maxOptotypeIndex", "autoRunIndex", "crowdingType", "crowdingDistanceCalculationType", "crowdingDistanceCalculationType", "testOnLineByLineIndex", "lineByLineDistanceType", "lineByLineHeadcountIndex", "vernierType", "vernierWidth", "vernierLength", "vernierGap", "gammaValue", "contrastOptotypeDiameter", "contrastTimeoutFixmark", "contrastMaxLogCSWeber", "gratingCPD", "gratingDiaInDeg", "gratingShapeIndex", "what2sweepIndex", "gratingCPDmin", "gratingCPDmax", "gratingContrastMichelsonPercent", "soundTrialYesIndex", "soundTrialNoIndex", "soundRunEndIndex"];
