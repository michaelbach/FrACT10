...
- (void) loadSound1 { //console.log("Sound>loadSound");
    buffer1 = null;
...
- (void) loadSound2 { //console.log("Sound>loadSound");
    buffer2 = null;
    var request = new XMLHttpRequest();
...
- (void) loadSound3 { //console.log("Sound>loadSound");
    buffer3 = null;
    var request = new XMLHttpRequest();
...
- (void) playSoundFromBuffer: (id) buffer { //console.log("Sound>playSoundFromBuffer");
...
- (void) play1 { //console.log("Sound>playSound1");
    [self playSoundFromBuffer: buffer1];
}
- (void) play2 { //console.log("Sound>playSound2");
    [self playSoundFromBuffer: buffer2];
}
- (void) play3 { //console.log("Sound>playSound3");
    [self playSoundFromBuffer: buffer3];
}


- (id) init { //console.log("Sound>init");
    self = [super init];
    if (self) {
